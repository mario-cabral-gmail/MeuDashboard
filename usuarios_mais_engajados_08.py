...
def app(arquivo, filtros):
    ...
    <h3 style="display:inline;">
        Usuários com mais participações
        <span class="tooltip">
            <b style="color:#888; font-size:1.1em; cursor:help;">&#9432;</b>
            <span class="tooltiptext">
                Lista os 3 usuários com mais participações e aprovações em treinamentos.<br>
                🕒 Contabiliza participações com início ou conclusão do módulo dentro do período selecionado.
            </span>
        </span>
    </h3>
